...
class CreateGroupCall(TLObject):  # type: ignore
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", random_id: int, rtmp_stream: Union[None, bool] = None, title: Union[None, str] = None, schedule_date: Union[None, int] = None) -> None:

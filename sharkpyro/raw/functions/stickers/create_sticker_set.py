...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    def __init__(self, *, user_id: "raw.base.InputUser", title: str, short_name: str, stickers: List["raw.base.InputStickerSetItem"], masks: Union[None, bool] = None, animated: Union[None, bool] = None, videos: Union[None, bool] = None, thumb: "raw.base.InputDocument" = None, software: Union[None, str] = None) -> None:
